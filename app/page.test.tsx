    ...
    <div className="relative min-h-[90vh] text-white">
      ...
      <header className="fixed inset-x-0 top-0 z-40  bg-black/30">
        <div className="w-full max-w-6xl mx-auto flex items-center justify-between px-3 sm:px-4 py-1">
          ...
          <nav className="space-x-4 text-[12px] leading-tight">
            ...
            <a href="/new" className="btn-ghost">
              Create plan
            </a>
          </nav>
        </div>
      ...
      <section className="relative z-10 min-h-[80vh] flex items-center">
        <div className="container">
          <Reveal>
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-semibold leading-[1.15] max-w-[44ch] drop-shadow-[0_2px_8px_rgba(0,0,0,0.35)] max-w-[18ch] sm:max-w-[22ch] font-playfair antialiased-strong">
              AIが、あなたの高揚感
              <br />
              そのままに旅程を描く。
              <br />
          ...
          <Reveal delay={0.1}>
            <p className="text-white/90 text-base sm:text-lg mt-5 max-w-[60ch] whitespace-pre-line">
              日程と興味を選ぶだけ。
              <br />
              時間最適のリアルなプランを自動生成。
              <br />
      ...
      <div className="relative z-10">
        <StickySteps
          steps={[
            ...
            {
              title: "生成",
              text: "移動時間や混雑も考慮した時間割を作成",
              image: "/images/kyoto.jpg",
            },
            {
              title: "予約導線",
              text: "主要予約サイトリンクでスムーズに予約",
      ...
      <section id="features" className="relative z-10 bg-white/95  text-black">
        <div className="container py-20">
          ...
          <p className="text-neutral-600 -mt-4 mb-6 text-sm whitespace-pre-line">
            写真をクリックしてイメージを膨らませましょう。
            <br />{" "}
          </p>
      ...
      <section id="how" className="relative z-10 text-black  bg-white/80 ">
        <div className="container py-20">
      ...
      {/* 強いCTA（フッター直前） */}
      <section
        className="relative z-10 bg-white shadow-lg text-center py-16"
        style={{
      ...
      >
        <div className="container">
          <Reveal>
            <h3 className="text-2xl font-semibold text-neutral-900">今すぐ旅程を作ってみる</h3>
          </Reveal>
          <Reveal delay={0.1}>
        ...
        <div className="container py-10">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <nav className="text-sm space-x-4 text-white/80">
              <a href="/new" className="hover:text-white">
                Create plan
              </a>
