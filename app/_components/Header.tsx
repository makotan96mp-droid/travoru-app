  ...
  return (
    <header className="sticky top-0 z-50 bg-slate-950/70 backdrop-blur border-b border-white/10">
      ...
      <div className="mx-auto max-w-6xl px-4 h-12 sm:h-12 sm:h-14 flex items-center justify-between">
        ...
        <a
          href="/"
          className="flex items-center gap-2 leading-none leading-none"
          aria-label="Travoru"
        >
          <Image
            decoding="async"
            src="/logo.png" /* 自動検出で書き換えているならそのパスに合わせてOK */
            alt="Travoru"
        ...
        <nav
          aria-label="主要ナビ"
          className="flex items-center gap-3 text-xs sm:text-xs sm:text-sm opacity-85"
        >
          <a href="/about" className="hover:opacity-100 leading-none">
            使い方
          </a>
          <a
            href="/new"
