    ...
    <div className="relative">
      ...
      <header className="relative z-10">
        <div className="container flex items-center justify-between py-5">
          <div className="text-xl font-semibold tracking-wide text-white drop-shadow">Travoru</div>
      ...
      {/* ヒーロー（テキストのみ。背景は固定動画） */}
      <section id="hero" className="relative z-10 min-h-[85vh] sm:min-h-[90vh] flex items-center text-white">
        <div className="container">
          <h1 className="text-4xl sm:text-6xl font-semibold leading-[1.15] max-w-[52ch] drop-shadow">
            AIが、動画の高揚感そのままに旅程を描く。<br /> 
          </h1>
          <p className="text-white/90 mt-5 max-w-[60ch]">
      ...
      {/* 人気の目的地（半透明で動画をうっすら見せつつ、読みやすさ優先） */}
      <section id="features" className="relative z-10 text-black bg-white/90 backdrop-blur-sm">
        <div className="container py-20">
          <h2 className="text-2xl sm:text-3xl font-semibold mb-6">人気の目的地</h2>
          <p className="text-neutral-700 -mt-4 mb-6 text-sm">写真をクリックしてイメージを膨らませましょう。<br /> </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            {[
              ...
              <article key={d.title} className="group relative rounded-2xl overflow-hidden shadow-[var(--shadow-soft)] transition-transform duration-300 will-change-transform hover:scale-[1.01]">
      ...
      {/* How it works（動画の上でも読みやすいよう半透明＋ブラー） */}
      <section id="how" className="relative z-10 text-black bg-neutral-50/90 backdrop-blur-sm">
        <div className="container py-20">
      ...
      {/* 折り返しCTA（半透明） */}
      <section className="relative z-10 bg-white/95 backdrop-blur text-center py-16">
        <div className="container">
          <h3 className="text-2xl font-semibold">今すぐ旅程を作ってみる</h3>
          <p className="text-neutral-700 mt-2">無料プレビュー（回数制限あり）。詳細は購入後に解禁。<br /> </p>
          <div className="mt-6">
