...
export default function Home() {
  return (
    <div className="relative min-h-[90vh] text-white">
      ...
      <header className="fixed top-0 w-full z-20 bg-black/30 backdrop-blur-sm">
        <div className="container flex items-center justify-between py-5">
          <div className="text-xl font-semibold tracking-wide">Travoru</div>
...
<section id="features" className="relative z-10 bg-white text-black">
      ...
      {/* 強いCTA（フッター直前） */}
      <section className="relative z-10 bg-white/95 backdrop-blur text-center py-16" style={{backgroundImage: "url(/images/wave.svg)", backgroundRepeat: "no-repeat", backgroundPosition: "center top", backgroundSize: "cover"}}>
        <div className="container">
